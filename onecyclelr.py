...
class OneCycleLR:
    ...
    Args:
        ...
        lr_max:                (int) max values of learning rate, if None default to 10 * lr
    ...
    Example:
        ...
        >>> scheduler = OneCycleLR(optimizer, num_steps=num_steps)
    ...
    def __init__(self,
        ...
        self.min_lr, self.max_lr = lr, max_lr
    ...
    def __repr__(self):
        return "OneCycleScheduler " + str({
            "num_steps": self.num_steps,
            "lr_range": (self.min_lr, self.max_lr),
            "momentum_range": (self.min_momentum, self.max_momentum),
            "annihilation_frac": self.annihilation_frac,
